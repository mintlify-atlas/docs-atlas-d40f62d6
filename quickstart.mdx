...
<CardGroup cols={2}>
  <Card title="Finetune GPT-2" icon="sliders" href="/training/finetuning">
    Get better results by finetuning a pretrained GPT-2 model
  </Card>
  
  <Card title="Train on Custom Data" icon="database" href="/concepts/data-preparation">
    Learn how to prepare and train on your own datasets
  </Card>
  
  <Card title="Reproduce GPT-2" icon="clone" href="/training/from-scratch">
    Train a GPT-2 (124M) model on OpenWebText from scratch
  </Card>
  
  <Card title="Model Configuration" icon="gear" href="/concepts/configuration">
